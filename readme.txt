...
2. f_worm.txt is fi.txt for i=(1..34) and eliminiating blank spaces. Lines = 2654
...
6. fasta_file + f_worm_uniq_after_hash.txt -----------> find_glyco_pep.cpp ---------------> peptide_worm_output.txt (<Identifier> <found sequences NX(!P)S/T>)
